...
/// ==============================
/// GetX Controller: Wellness Form
/// ==============================
class WellnessFormController extends GetxController {
  // Dropdowns / inputs
...
class WellnessForm extends StatelessWidget {
  WellnessForm({super.key});

  final form = Get.put(WellnessFormController());
  ...
  static const String API_ENDPOINT = 'https://api.example.com/wellness/request'; // <-- replace
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                const CustomAppBar(title: 'Wellness'),
