...
import 'package:abyansf_asfmanagment_app/view/screens/all_form_pages/hotel_and_villas_screeen.dart';
...
Future<void> main() async {
  ...
  runApp(
      GetMaterialApp(
        ...
        home: ManagementApp(widget: HotelAndVillasScreen(subCategoryId: 1)),
